                            ...
                            <div class ="row">
                                <div class="col-md-4 register1">
                                    ...
                                    <c:if test="${not empty uploadedFilePath}">
                                        <div>
                                            <img src="nameService/${uploadedFilePath}" style="width: 200px;height: 200px;">
                                        </div>                   
                                    </c:if>
                                ...
                                <form action="" method="post">
                                    <div class="col-md-4 register">
                                        <p>URL Ảnh Service</p>
                                        <c:if test="${not empty uploadedFilePath}">
                                                <input type="text" name="urlService" placeholder="Nhập Url Ảnh Của Dịch Vụ" value="nameService/${uploadedFilePath}" required>                  
                                        </c:if>
                                        <c:if test="${empty uploadedFilePath}">
