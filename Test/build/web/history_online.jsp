...
<html>
    ...
    <body>
        ...
        <div class="row infor_account">
            ...
            <div class="inforAccount_right">
                ...
                <div id="noHistory" style="color:red;display: none;text-align: center">
    ...
    <script>
        ...
        document.querySelector('#noHistory').style.display = 'block'; // Hiển thị thông báo khi không có dữ liệu
        } else {
        document.querySelector('#noHistory').style.display = 'none'; // Ẩn thông báo khi có dữ liệu
        ...
        if (thisPage != count && count > 1) { // Kiểm tra count > 1 để đảm bảo có ít nhất 2 trang mới hiển thị nút NEXT
